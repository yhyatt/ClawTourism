...
_CITIES: dict[str, dict] = {
    ...
    "new york": {
        "morning": [
            Activity("Central Park", "Morning walk — Bethesda Fountain, Bow Bridge, Sheep Meadow",
                     1.5, "free", kids_friendly=True),
            Activity("High Line", "Elevated park from Meatpacking to Hudson Yards — open from 7am",
                     1.5, "free", kids_friendly=True),
            Activity("Brooklyn Bridge walk", "Start Manhattan side, walk to DUMBO + Jane's Carousel",
                     1.5, "free", kids_friendly=True),
            Activity("burger joint", "Iconic hidden burger spot inside Le Parker Meridien hotel — morning queue worth it",
                     0.5, "$20–30", kids_friendly=True),
        ],
        "afternoon": [
            Activity("The Met", "Metropolitan Museum of Art — Egyptian wing, rooftop views",
                     3.0, "$30 suggested", "metmuseum.org", indoor=True),
            Activity("DUMBO + Brooklyn Bridge Park", "Manhattan views, pebble beach, Jane's Carousel",
                     2.0, "free", kids_friendly=True),
            Activity("McSorley's Old Ale House", "NYC's oldest bar, 1854 — cash only, dark ale",
                     1.5, "$20–30", kids_friendly=False),
            Activity("Vanderbilt Market", "Food hall under Grand Central — Midtown lunch",
                     1.0, "$20–30", kids_friendly=True),
        ],
        "evening": [
            Activity("Tatiana by Kwame Onwuachi", "Acclaimed Caribbean — Lincoln Center. Book Resy",
                     2.5, "$100+", "resy.com", kids_friendly=False),
            Activity("Minetta Tavern", "West Village institution — Black Label Burger, classic steaks",
                     2.5, "$100+", "reserve ahead", kids_friendly=False),
            Activity("Via Carota", "No reservations, West Village Italian — arrive early or late",
                     2.5, "$50–100", kids_friendly=False),
            Activity("Café Habana", "Nolita Cuban — grilled corn, Cuban sandwich, great vibe",
                     2.0, "$20–30", "no reservations", kids_friendly=False),
            Activity("The Honey Well", "UWS cocktail bar — near the Airbnb, 4.7★",
                     2.0, "$30–50", kids_friendly=False),
            Activity("The Dead Poet", "Amsterdam Ave Irish pub — 2 min from Airbnb, classics",
                     2.0, "$10–20", kids_friendly=False),
            Activity("Smalls Jazz Club", "Greenwich Village jazz — sets 7:30pm & 10:30pm",
                     2.5, "$25 cover", "smallslive.com", kids_friendly=False),
            Activity("SPIN New York", "Ping pong bar — Flatiron or Midtown, good for groups",
                     2.0, "$20–30", kids_friendly=False),
        ],
    },
